...
//            String url = "http://api.demo.dwsurvey.online/api/ar/category/"+products_intent2+"/products?pg=1";
...
//        {
//            com.android.volley.RequestQueue queue = Volley.newRequestQueue(ff.this);
//            String url = "http://api.demo.dwsurvey.online/api/ar/category/"+products_intent+"/products?pg=1";
//            StringRequest stringRequest = new StringRequest(com.android.volley.Request.Method.GET, url,
//                    new com.android.volley.Response.Listener<String>() {
//                        @Override
//                        public void onResponse(String response) {
...
//        {
//            com.android.volley.RequestQueue queue = Volley.newRequestQueue(ff.this);
//            String url = "http://api.demo.dwsurvey.online/api/en/category/"+products_intent2+"/products?pg=1";
//            StringRequest stringRequest = new StringRequest(com.android.volley.Request.Method.GET, url,
//                    new com.android.volley.Response.Listener<String>() {
//                        @Override
//                        public void onResponse(String response) {
...
//        {
//            com.android.volley.RequestQueue queue = Volley.newRequestQueue(ff.this);
//            String url = "http://api.demo.dwsurvey.online/api/en/category/"+products_intent+"/products?pg=1";
//            StringRequest stringRequest = new StringRequest(com.android.volley.Request.Method.GET, url,
//                    new com.android.volley.Response.Listener<String>() {
//                        @Override
//                        public void onResponse(String response) {
