...
public class SnapRecyclerAdapter4 extends RecyclerView.Adapter<SnapRecyclerAdapter4.ReyclerViewHolder> {

    private LayoutInflater layoutInflater;
    private Context context;
    private ArrayList<Item> items;

    public SnapRecyclerAdapter4(Context context, ArrayList<Item> items) {
    ...
    public ReyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View item = layoutInflater.inflate(R.layout.item_recycler_view_products4, parent, false);
