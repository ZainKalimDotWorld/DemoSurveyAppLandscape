...
public class SnapRecyclerAdapter3 extends RecyclerView.Adapter<SnapRecyclerAdapter3.ReyclerViewHolder> {

    private LayoutInflater layoutInflater;
    private Context context;
    private ArrayList<Item> items;

    public SnapRecyclerAdapter3(Context context, ArrayList<Item> items) {
    ...
    public ReyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View item = layoutInflater.inflate(R.layout.item_recycler_view_products3, parent, false);
