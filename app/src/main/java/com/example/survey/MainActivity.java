...
import static com.example.survey.Feedback_Menu.swToggle;
...
//            Toast.makeText(this, "IMEI IS:-" + IMEI, Toast.LENGTH_SHORT).show();
            ...
            try {
                ...
                okhttp3.Request request = new okhttp3.Request.Builder() .url("http://api.demo.dwsurvey.online/api/Branch/Login").post(body).build();
...
//
    private void retreivebranches()
    {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "http://api.demo.dwsurvey.online/api/Branch/GetBranches", new Response.Listener<String>() {
                    @Override
